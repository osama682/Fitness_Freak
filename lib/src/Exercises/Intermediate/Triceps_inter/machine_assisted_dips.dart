...
class machine_assisted_dips extends StatelessWidget {
  const machine_assisted_dips({Key? key}) : super(key: key);
...
// color: Color(0xFF14E5B3),
            ...
            Padding(
              ...
              child: Container(
                child: Image.asset(
                  'assets/Machine_assisted_triceps_dip.gif',
                ),
              ),
            ),
            Padding(
