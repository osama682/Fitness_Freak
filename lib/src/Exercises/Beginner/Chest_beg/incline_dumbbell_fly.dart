...
class Myincline_fly extends StatelessWidget {
  const Myincline_fly({Key? key}) : super(key: key);
...
// color: Color(0xFF14E5B3),
            ...
            Padding(
              ...
              child: Container(
                child: Image.asset(
                  'assets/Incline_dumbbell_fly_chest.gif',
                ),
              ),
            ),
            Padding(
