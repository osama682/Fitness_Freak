...
class exercise_ball_wall_squat extends StatelessWidget {
  const exercise_ball_wall_squat({Key? key}) : super(key: key);
...
// color: Color(0xFF14E5B3),
            ...
            Padding(
              ...
              child: Container(
                child: Image.asset(
                  'assets/Exercise_Ball_Wall_Squat_Thighs_legs.gif',
                ),
              ),
            ),
            Padding(
