...
class dumbbell_upright_shoulder_exten extends StatelessWidget {
  const dumbbell_upright_shoulder_exten({Key? key}) : super(key: key);
...
// color: Color(0xFF14E5B3),
            ...
            Padding(
              ...
              child: Container(
                child: Image.asset(
                  'assets/Dumbbell-Upright-Shoulder-External-Rotation.gif',
                ),
              ),
            ),
            Padding(
